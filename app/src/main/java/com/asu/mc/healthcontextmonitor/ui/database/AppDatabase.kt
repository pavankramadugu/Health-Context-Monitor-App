...
import com.asu.mc.healthcontextmonitor.ui.database.dao.HealthContextDao
...
@Database(
    entities = [SymptomRating::class, HeartRateEntity::class, RespRateEntity::class,
        HealthContextEntity::class], version = 6
)
abstract class AppDatabase : RoomDatabase() {
    abstract fun symptomRatingDao(): SymptomRatingDao
    abstract fun heartRateDao(): HeartRateDao
    abstract fun respRateDao(): RespRateDao
    abstract fun healthContextDao(): HealthContextDao
